  ...
  _p[57] = {
    value: function (require, exports, module) {
      ...
      Module.register('ProgressModule', function () {
        ...
        var FAIL_PATH =
          'M5.5,6.9L6.9,5.5L10,8.6l3.1,-3.1l1.4,1.4L11.4,10l3.1,3.1l-1.4,1.4L10,11.4l-3.1,3.1l-1.4,-1.4L8.6,10z';
  ...
  _p[77] = {
    value: function (require, exports, module) {
      ...
      theme.register('byte-blue', {
        ...
        'marquee-background': 'rgba(51, 112, 255, 0.1)',
        'marquee-stroke': '#60a5fa',
        'drop-hint-color': '#3370ff',
        'drop-hint-width': 4,
        'order-hint-area-color': 'rgba(51, 112, 255, 0.18)',
        'order-hint-path-color': '#2563eb',
        'order-hint-path-width': 1,
        'text-selection-color': '#1d4ed8',
        'line-height': 1.5,
      });
      var name;
      for (name in plans) {
